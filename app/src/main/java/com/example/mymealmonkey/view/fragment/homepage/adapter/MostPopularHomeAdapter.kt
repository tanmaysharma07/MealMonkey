...
class MostPopularHomeAdapter(val context: com.example.mymealmonkey.view.fragment.homepage.HomePageFragment, private val dataset:List<MostPopularHomeData>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val adapterLayout = LayoutInflater.from(parent.context).inflate(R.layout.most_popular_home_item,parent,false)
